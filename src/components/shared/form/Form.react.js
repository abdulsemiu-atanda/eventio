...
class Form extends React.Component {
  ...
  errors() {
    return this.props.errors ? this.state.errors.concat(this.props.errors) : this.state.errors
  }
  ...
  setFormValues(key, value) {
    ...
    if (key === 'email') trimmedValue = value.trim()
  ...
  validate() {
    ...
    const errors = validators
      .map(validator => validator.validator(validator.name, this.formData()))
      .filter(validator => typeof validator !== 'undefined')
